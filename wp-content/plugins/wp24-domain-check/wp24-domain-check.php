...
if ( ! defined( 'WP24_DOMAIN_CHECK_VERSION' ) )
	define( 'WP24_DOMAIN_CHECK_VERSION', '1.5.3' );

if ( ! defined( 'WP24_DOMAIN_CHECK_DATABASE_VERSION' ) )
	define( 'WP24_DOMAIN_CHECK_DATABASE_VERSION', '1.1.0' );

// textdomain for translations
load_plugin_textdomain( 'wp24-domaincheck', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
